 ...
 */
public abstract class AbstractViewPaymentListViewModel extends ParallelTest {
    ...
    public AbstractViewPaymentListViewModel() {
        this("", By.tagName("body"));
    }

    protected AbstractViewPaymentListViewModel(String route, By rootSelector) {
        this.route = route;
